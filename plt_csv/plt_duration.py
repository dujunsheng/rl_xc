...
no_stop = pd.read_csv('../record/no_stop_test_tripinfo.csv', sep=';')
stop = pd.read_csv('../record/stop_test_tripinfo.csv', sep=';')
...
# sns.distplot(data['tripinfo_duration_y'], bins=int(data['tripinfo_duration_y'].max()), kde=False, hist_kws={'color':'purple'},
...
plt.title('车辆形成时间增减', fontsize=16)
plt.legend()
